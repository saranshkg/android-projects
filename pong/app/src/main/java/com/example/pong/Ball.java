...
class Ball {
    // These are the member variables, private and with m prefix
    private RectF mRect;
    ...
    // This is the constructor method. It is called by the code:
    // mBall = new Ball(mScreenX); in the PongGame class
    Ball(int screenX) {
    ...
    void update(long fps) {
        // Move the ball based upon the horizontal (mXVelocity) and vertical (mYVelocity)
        // speed and current frame rate (fps)
    ...
    void reset(int x, int y) {
        ...
        // How fast will the ball travel? Game difficulty can be managed
        mYVelocity = -(y / 3);
        mXVelocity = (y / 3);
    }
