...
// These are all the classes of other people's (Android) code that we use for Sub Hunter
...
public class SubHunter extends Activity {
    ...
    */
    ...
    /*
    This code will execute when a new game needs to be started. It will
    happen when the app is first started and after the player wins a game.
    */
    void newGame(){
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if((motionEvent.getAction() & MotionEvent.ACTION_MASK) == MotionEvent.ACTION_UP){
            // Process the player's shots by passing the coordinates of the player's finger to takeShot
    ...
    calculate the distance from the sub' and decide a hit or miss
    */
